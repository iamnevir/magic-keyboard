...
function Image({ c = new THREE.Color(), url, ...props }: any) {
...
export default function MagicKeyboardMainTop() {
  return (
    <Canvas gl={{ antialias: false }} dpr={[1, 1.5]}>
      <Suspense fallback={null}>
        <ScrollControls damping={2} pages={3}>
          ...
          <Scroll html>
            <h1 className=" absolute top-[60vh] left-[0.5em] text-[100px]">
              magic
            </h1>
            <h1 className=" absolute top-[120vh] left-[60vw] text-[100px]">
              for
            </h1>
            <h1 className=" absolute top-[198vh] left-[5vw] text-[40vh]">
              keyboard
            </h1>
          </Scroll>
        </ScrollControls>

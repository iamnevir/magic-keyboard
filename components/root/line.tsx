    ...
    <div className="flex items-end w-full">
      <div className="relative w-full  h-px mb-5">
        <div
          ...
          className="relative z-[10] h-32  top-[-40px]"
        ></div>
        <svg className="absolute w-full h-[400px] top-[-250px]">
          <path
            ref={path}
            className="stroke-current dark:text-white text-black stroke-[1px] fill-none"
          ></path>
        </svg>
      </div>
    </div>
